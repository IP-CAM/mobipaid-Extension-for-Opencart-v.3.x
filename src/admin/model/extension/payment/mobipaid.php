 ...
 *
 */
class ModelExtensionPaymentMobipaid extends Model {
	...
	/**
	 * Adding Mobipaid order statuses into the opencart database
	 *
	 * @return void
	 */
	...
	/**
	 * Install the Mobipaid module
	 *
	 * @return void
	 */
	public function install() {
		$this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "payment_mobipaid_orders` (
		...
		$this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "payment_mobipaid_data` (
					`id` INT(11) NOT NULL AUTO_INCREMENT,
					`order_id` INT(11) NOT NULL,
